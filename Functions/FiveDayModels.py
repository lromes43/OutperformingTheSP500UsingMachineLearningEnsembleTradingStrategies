...
def binary_prediction_func(data, prediction_date):
    ...
    binary = joblib.load("/Users/lukeromes/Desktop/Sp500Project/RetrainedModels/FinalBoostedFiveDayClassifier.job.lib")
    ...
    results_df_filtered_binary.to_csv("/Users/lukeromes/Desktop/Personal/Sp500Project/DailyPredictions/FiveDay/Five_Day_Results_df_filtered_binary.csv")
...
def cont_prediction_func(data, prediction_date):
    ...
    results_df_filtered_cont.to_csv("/Users/lukeromes/Desktop/Personal/Sp500Project/DailyPredictions/FiveDay/Five_Day_Results_df_filtered_cont.csv")
...
def model_results_merging(data1, data2):
    ...
    output_path = "/Users/lukeromes/Desktop/Personal/Sp500Project/DailyPredictions/FiveDay/Five_Day_Merged_Final.csv"
