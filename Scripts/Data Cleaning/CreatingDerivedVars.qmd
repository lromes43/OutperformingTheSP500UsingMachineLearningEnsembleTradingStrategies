...
cols_reordered = [
    ...
    'weekly_averages','Weekly_SD',  'Two_week_averages', 'Two_Week_SD ', 'Monthly_SD','Monthly_Average', 'Daily_Return', 
]
...
Want to add another column that is the next day's value
...
data.to_feather('CORRECTEDFINALDATA.feather')
```