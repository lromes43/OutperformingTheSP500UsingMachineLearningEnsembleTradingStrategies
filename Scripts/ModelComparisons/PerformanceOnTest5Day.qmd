...
actual = test['Movement_5_day'].astype(int)
...
plt.title("Final Five Day Binary Confusion Matrix")
plt.show()
...
y_final = test['next_5_day_pct_change'].astype(float)
...
MSE: 0.002565356856586501
MSE_percent: 0.2565356856586501
 one day rmse: 0.05064935198584974
one day rmse percent: 5.0649351985849735
Within ±0.5% accuracy (in percentage points): 0.8997565922920893
...
y_true_binary = test['Movement_5_day'].astype(int) 
...
print(f"\nArea Under the Curve (AUC) for 5-Day Movement: {auc_score:.4f}")
...
plt.title('ROC Curve for 5-Day Movement Prediction')
