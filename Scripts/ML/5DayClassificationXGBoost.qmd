...
Need to make another movement column for 5 days for train and test
...
test = pd.concat(five_day_movement_list)
```
...
Up to a 78% accuracy for predicting 5 day movement not bad!


```{python}
final_model_filename = 'BoostedFiveDayClassifier.job.lib'
