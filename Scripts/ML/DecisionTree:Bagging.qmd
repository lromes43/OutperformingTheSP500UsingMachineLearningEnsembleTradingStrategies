...
```{python}
import pickle
# Check the path carefully! Use the correct filename
file_path = '/Users/lukeromes/Desktop/Personal/Sp500Project/Scripts/ML/decision_tree_model.pkl' 
with open(file_path, 'rb') as file:
    loaded_model = pickle.load(file) # This is the correct loading function
```
