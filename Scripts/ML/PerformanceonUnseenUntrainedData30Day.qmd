...
y_final = transformed_data['next_30_day_pct_change'].astype(float)
...
merged_cont_thirty = merged_cont_five.rename(columns = {'next_5_day_pct_change': 'actual'})
```
