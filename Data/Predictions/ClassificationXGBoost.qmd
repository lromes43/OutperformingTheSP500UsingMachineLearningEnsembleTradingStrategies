...
```{python}
train= pd.read_feather("/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/Data/TrainData.feather")
...
```{python}
num_boost_rounds = 316
best_gamma = 0.0001
tuned_depth = 7
tuned_min_child_weight = 8
...
```{python}
import joblib
final_model_filename = '/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/Models/FinalBoostedOneDayClassifier.job.lib'
