...
import time
data = pd.read_feather("/Users/lukeromes/Desktop/Personal/Sp500Project/Data/FinalTestData.featherForPipeline")
```
...
test
test.to_feather('ModelFuturePerformanceDataCleaned.feather')
```


#Make function to make the data good for the models now
