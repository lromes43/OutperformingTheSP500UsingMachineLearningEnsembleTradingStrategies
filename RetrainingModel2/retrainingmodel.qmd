...
```{python}
data = pd.read_feather("/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/CORRECTEDFINALDATA.feather")
...
```{python}
gamma_results = []
gamma = [0.00001, 0.001, 0.05, 0.1, .15, .2, .3]
params = {
    "objective": 'binary:logistic',
    "eta": .1,
    "eval_metric": ['error', 'auc'],
...
pos = y_train_final.sum()                   # number of 1s
neg = len(y_train_final) - pos              # number of 0s
