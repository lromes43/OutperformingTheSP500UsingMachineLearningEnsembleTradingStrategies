...
download_dir = "/Users/lukeromes/Desktop/Sp500Project/Data/DataPipelineData"
combined_file = "/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/Data/combined_sp500_data.csv"
final_feather = "/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/FinalTestData.feather"
...
try:
    ...
    print("Error loading S&P500 list:", e)
    sys.exit(1)
...
for i, ticker in enumerate(tickers):
    path = os.path.join(download_dir, f"{ticker}.csv")
...
print("Combining all downloaded CSV files...")
...
df.to_feather("/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/pulled.feather")
...
```{python}
test = pd.read_feather("/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/pulled.feather")
```
...
```{python}
import pandas as pd
data = pd.read_feather("/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/pulled.feather")
...
def train_test_split_by_date(data_path, train_end_date, test_start_date):
    ...
    train_subset.to_feather("/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/TrainData.feather")
    test_subset.to_feather("/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/TestData.feather")
...
```{python}
from datetime import date
data_path = "/Users/lukeromes/Desktop/Personal/Sp500Project/RetrainingModel2/CHECKFEATHER.feather"
train_end_date = date(2025,9,20)
test_start_date = date(2025,9,21)
