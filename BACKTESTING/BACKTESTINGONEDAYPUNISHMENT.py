...
BINARY_MODEL_PATH = "/Users/lukeromes/Desktop/Sp500Project/RETRAINEDINITIALBINARYONE.job.lib"
CONT_MODEL_PATH = "/Users/lukeromes/Desktop/Sp500Project/RETRAINEDINITIALCONT.joblib"
...
trade_log_df = pd.DataFrame(trade_log).to_csv('trade_log_punishment.csv', index=False)
